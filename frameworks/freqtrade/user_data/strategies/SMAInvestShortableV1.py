...
class SMAInvestShortableV1(IStrategy):
    """
    ...
    def informative_pairs(self):
        return [
            ("BTCUSDT", self.timeframe),
            ("BTCUSDT", self.informative_timeframe)
        ]
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                # 1: BTC/USDT price below main timeframe
                    (
                            dataframe[f'close_{self.timeframe}'] <
                            dataframe[f'sma200_{self.timeframe}']) &

                    # 2: BTC/USDT price below informative timeframe
                    (
                            dataframe[f'close_{self.informative_timeframe}'] <
                            dataframe[f'sma200_{self.informative_timeframe}']) &
