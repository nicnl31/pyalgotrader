...
class SMAInvestV2(IStrategy):
    """
    This SMA Investing strategy is motivated by
    https://medium.datadriveninvestor.com/i-used-this-one-indicator-to-buy-stocks-that-moved-up-80-when-the-so-called-experts-called-a-848fa159914c
        ...
        return {
            ...
            'subplots': {
                f"BTC/USDT {self.timeframe}": {
                    ...
                    f'ema200_{self.timeframe}': {'color': '#2CB851'}
                },
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        informative_4h["ema200"] = ta.EMA(informative_4h, timeperiod=200)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                (
                    # 1: BTC/USDT price crosses above informative timeframe
                    (
                    ...
                    # 2: BTC/USDT price above main timeframe
                    (
                ...
                (
                    # 1: BTC/USDT price crosses above main timeframe
                    (
                        qtpylib.crossed_above(
                            dataframe[
                                f'close_{self.timeframe}'],
                            dataframe[
                                f'sma200_{self.timeframe}']
                        )
                    ) &
            ...
            (
                ...
                (
                    qtpylib.crossed_below(
                        dataframe[f'close_{self.timeframe}'],
                        dataframe[f'ema200_{self.timeframe}']
                    )
                ) &
