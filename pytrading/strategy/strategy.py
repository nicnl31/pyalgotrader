...
################################################################################
# The Strategy object encapsulates all calculations on market data that generate
# advisory signals to a Portfolio object. All strategy logics are within this
# class.
################################################################################
...
class Strategy(object):
	...
	particular symbols based on the inputs of Bars (OHLCV) generated by a
	DataHandler object.
	...
	def calculate_signals(self):
		"""
		Provides the mechanism for calculating the list of signals.
		:return:
		"""
